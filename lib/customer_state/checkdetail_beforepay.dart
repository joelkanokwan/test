...
class CheckDetailBeforePay extends StatefulWidget {
  const CheckDetailBeforePay({Key? key}) : super(key: key);

  @override
  _CheckDetailBeforePayState createState() => _CheckDetailBeforePayState();
}

class _CheckDetailBeforePayState extends State<CheckDetailBeforePay> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Check detail before pay'),
      ),
      // body: Container(
